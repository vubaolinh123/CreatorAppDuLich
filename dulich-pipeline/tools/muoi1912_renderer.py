...
GUIDE_SECTIONS = [
    {
        "title":         "KHÔNG NÊN BOOK PHÒNG TRƯỚC",
        "category":      "khách sạn",
        "section_label": "KHÁ CHỖ LƯU TRÚ Ý TỶ",
        "bullets": [
            "• Vào mùa cao điểm như lễ tết hay cuối tuần, nếu bạn lô phòng trước thì dễ bị chặt chém",
            "• Nên book phòng trước 1-3 tuần, check uy tín từ khi còn mới, tránh cọc vi lừa đảo bay hết",
            "• Nếu làm nhân viên địa phương, nhờ hỏi các quán quen biết để giảm giá",
            "• Cân nhắc Airbnb — nhiều chỗ rẻ và riêng tư hơn khách sạn",
            "• Tránh book trên mạng xã hội không có đánh giá",
        ],
    },
    {
        "title":         "KHÔNG ĐẾN QUÁ TIN VÀO ẢNH MẠNG",
        "category":      "tham quan",
        "section_label": "CÓ 3 ĐIỂM CHECK-IN PHẢI LẦP",
        "bullets": [
            "• Thực tế đôi khi ko giống trên ảnh — check nhiều nguồn",
            "• 1 số điểm check-in hot hit trên TikTok lựa những người ngoài địa phương nhìn bắt mắt hơn",
            "• Nên xem review từ nhiều nguồn, có video thực tế lại càng tốt",
            "• Tránh đi Langbiang vào trưa nắng — leo bộ rất mệt",
            "• Vườn hoa thành phố đẹp nhất buổi sáng sớm 6-7h",
        ],
    },
    {
        "title":         "NHỮNG ĂN UỐNG NGOÀI CHỢ",
        "category":      "quán ăn",
        "section_label": "BEST QUÁN BEST TRY",
        "bullets": [
            "• Không đánh đồng những ma hạn chế ăn uống ở chợ nhé, dễ bị chặt chém",
            "• Nên đọc review trên GG Maps, đi theo máy người địa phương chi phí, nhờ hỏi trước khi đặt được xuống nhà",
            "• Đi chơi ở chợ khi đã no — tránh bị dụ mua đồ đắt",
            "• Bánh mì Đà Lạt buổi sáng ngon và rẻ",
            "• Thử sườn cay — đặc sản không thể bỏ qua",
        ],
    },
]
